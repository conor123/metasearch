...
<div class="container">
	...
	<div class="mini-unit">
		...
		<h2 class="font-effect-shadow-multiple" style = "text-shadow: 2px 2px #999999; font-family: 'Audiowide';">Help</h2>
		<p>Using Re-Search is easy with the help of this guide.</p></br>
	...
	<div>
		...
		<ol>
			<li>Navigate to the homepage by clicking the link "Re-Search" in the top left corner</li>
		...
		<ol>
			...
			<li><a href = "feedbackform.php">User Survey</a></li>
		...
		<p>This Search Engine collects results from Google, Bing (Microsoft's Search engine) and Blekko (another reputable Search Engine).</p>
		<ul>
		...
		<hr>
		<figure>
			<img src="img/UI_Options.png" alt="Screen shot of the homepage" />
